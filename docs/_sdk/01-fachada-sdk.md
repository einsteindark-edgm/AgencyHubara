...
| `src.sdk.runtime` | `WORKSPACE_VAULT_DIR`, `FilesystemMetadataStore`, `atomic_write_json`, `get_temporal_client`, `with_heartbeat`, `setup_logging`, `client_ip` (IP real detrás del proxy: la clave de todo límite por IP en routers expuestos) |
