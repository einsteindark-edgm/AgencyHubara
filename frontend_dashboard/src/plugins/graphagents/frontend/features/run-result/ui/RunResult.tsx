 ...
 * (`useRun`) y monta la suscripción al stream (`useGraphAgentsRunEvents`): así
 * el status, el timeline de eventos y el resultado/error se actualizan solos a
 * medida que el backend republica los cambios al dominio `graphagents`.
 *
...
import {
  ...
  useRun,
} from "@plugins/graphagents/frontend/entities/graphagents-run";
