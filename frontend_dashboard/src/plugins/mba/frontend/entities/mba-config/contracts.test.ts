...
describe("mbaConfigSchema", () => {
  it("parses the real shape of GET /api/mba/agents/{id}/config", () => {
    ...
    expect(parsed.settings.never_say_phrases[0]).toEqual({ phrase: "vos", source: "agent.yaml" });
    ...
    expect(parsed.workspace).toBe("hubara_agency/src/plugins/mba/agents/sales");
