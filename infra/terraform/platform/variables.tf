...
variable "secret_keys" {
  ...
  default = [
    ...
    "HUBARA_MBA_API_KEY",
    # Interruptores del lado de Hubara para Meta Business Agent (estamos en
    # producción). MBA_STANDBY_ENABLED: "1" enciende el oído `standby` (D1.4);
    # placeholder/vacío = APAGADO. MBA_CUSTOMER_ALLOWLIST: lista CERRADA de
    # clientes (E.164 separados por coma) a los que Hubara les acepta tráfico
    # de MBA (standby + connector tools); placeholder/vacío = NADIE. Ambos se
