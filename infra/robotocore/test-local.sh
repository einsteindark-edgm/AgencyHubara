...
assert "SSM HUBARA_PUBLIC_API_URL = api_url del tenant"  "a ssm get-parameter --name /hubara/hubara/HUBARA_PUBLIC_API_URL --query Parameter.Value --output text | grep -qx 'https://98-88-237-207.sslip.io'"
