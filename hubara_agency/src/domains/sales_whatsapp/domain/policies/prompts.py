...
Estos textos son business logic: codifican la decision de como hablarle al usuario o
al LLM. Viven aqui (no en el workflow) para que sean testeables sin Temporal y para
que el cambio de un prompt sea un PR plano sin tocar el grafo de tasks de Temporal.
"""
