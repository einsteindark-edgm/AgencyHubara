...
| "¿De qué color es el portavelas / el plato?" | Solo aplica a productos con portavela (ej. Dúo Zodiacal); si no lo trae, dilo y no hables de sus colores. Si lo trae: "Lo escoges después: te enviamos una foto con los colores disponibles." NUNCA prometas un color específico ni lo fijes como variante. |
