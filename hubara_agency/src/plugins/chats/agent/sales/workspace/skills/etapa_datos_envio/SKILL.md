...
- **Valor del envío**: si preguntan cuánto vale → `send_shipping_rates` (mensaje estándar). NUNCA des un valor de envío como definitivo ni un total que lo incluya: el resumen del pedido lo muestra "Por confirmar" y el sistema lo recalcula con la transportadora antes de despachar.
