...
def admin_url(base_url: str, entity_id: str, *segments: str) -> str:
    return "/".join([base_url.rstrip("/"), entity_id, *(str(s).strip("/") for s in segments)])
...
class MbaAdminPort(Protocol):
    ...
    async def put_business_info(self, entity_id: str, body: dict[str, Any]) -> dict[str, Any]: ...
    ...
    async def list_skills(self, entity_id: str, *, agent_id: str | None = None) -> list[dict[str, Any]]: ...
    ...
    async def list_connector_tools(self, entity_id: str, connector_id: str) -> list[dict[str, Any]]: ...

    async def create_connector_tool(self, entity_id: str, connector_id: str, body: dict[str, Any]) -> dict[str, Any]: ...

    async def update_connector_tool(self, entity_id: str, connector_id: str, tool_id: str, body: dict[str, Any]) -> dict[str, Any]: ...
    ...
    async def update_ui_skill(self, entity_id: str, ui_skill_id: str, body: dict[str, Any]) -> dict[str, Any]: ...
    ...
    async def add_allowlist(self, entity_id: str, consumer_phone_number: str) -> dict[str, Any]: ...
...
class MetaMbaAdmin:
    ...
    async def onboard(self, entity_id: str, *, catalog_id: str | None = None) -> str:
        ...
        return str(_as_dict(await self._call("POST", entity_id, "agent_onboarding", body=body, creates=True)).get("agent_id") or "")
    ...
    async def put_settings(self, entity_id: str, body: dict[str, Any], *, agent_id: str | None = None) -> dict[str, Any]:
        params = {"agent_id": agent_id} if agent_id else None
        return _as_dict(await self._call("PUT", entity_id, "agent_config/settings", body=body, params=params))

    # -- knowledge ---------------------------------------------------------

    async def get_business_info(self, entity_id: str) -> dict[str, Any]:
        return _as_dict(await self._call("GET", entity_id, "agent_config/business_info"))
    ...
    async def create_faq(self, entity_id: str, body: dict[str, Any]) -> dict[str, Any]:
        return _as_dict(await self._call("POST", entity_id, "agent_config/faq", body=body, creates=True))
    ...
    async def list_skills(self, entity_id: str, *, agent_id: str | None = None) -> list[dict[str, Any]]:
        params = {"agent_id": agent_id} if agent_id else None
        return _as_list(await self._call("GET", entity_id, "agent_config/skills", params=params))

    async def create_skill(self, entity_id: str, body: dict[str, Any], *, agent_id: str | None = None) -> dict[str, Any]:
        params = {"agent_id": agent_id} if agent_id else None
        return _as_dict(await self._call("POST", entity_id, "agent_config/skills", body=body, params=params, creates=True))
    ...
    async def create_connector(self, entity_id: str, body: dict[str, Any]) -> dict[str, Any]:
        return _as_dict(await self._call("POST", entity_id, "agent_connectors", body=body, creates=True))
    ...
    async def upsert_connector_api_key(self, entity_id: str, connector_id: str, api_key_config: dict[str, Any]) -> dict[str, Any]:
        ...
        return _as_dict(
            await self._call("POST", entity_id, "agent_connectors", connector_id, "upsertApiKey", body={"api_key_config": api_key_config})
        )

    async def list_connector_tools(self, entity_id: str, connector_id: str) -> list[dict[str, Any]]:
        return _as_list(await self._call("GET", entity_id, "agent_connectors", connector_id, "tools"))

    async def create_connector_tool(self, entity_id: str, connector_id: str, body: dict[str, Any]) -> dict[str, Any]:
        return _as_dict(await self._call("POST", entity_id, "agent_connectors", connector_id, "tools", body=body, creates=True))
...
class FakeMbaAdmin:
    ...
    @staticmethod
    def _update(bucket: list[dict[str, Any]], item_id: str, body: dict[str, Any]) -> dict[str, Any]:
    ...
    async def update_connector(self, entity_id: str, connector_id: str, body: dict[str, Any]) -> dict[str, Any]:
        ...
        return self._update(self.connectors.setdefault(entity_id, []), connector_id, body)
    ...
    async def upsert_connector_api_key(self, entity_id: str, connector_id: str, api_key_config: dict[str, Any]) -> dict[str, Any]:
        self._record("upsert_connector_api_key", entity_id, connector_id, api_key_config)
        return self._update(self.connectors.setdefault(entity_id, []), connector_id, {"auth_config": {"api_key": api_key_config}})
    ...
    async def create_connector_tool(self, entity_id: str, connector_id: str, body: dict[str, Any]) -> dict[str, Any]:
        ...
        return self._create(self.tools.setdefault((entity_id, connector_id), []), "tool", body)

    async def update_connector_tool(self, entity_id: str, connector_id: str, tool_id: str, body: dict[str, Any]) -> dict[str, Any]:
        self._record("update_connector_tool", entity_id, connector_id, tool_id, body)
        return self._update(self.tools.setdefault((entity_id, connector_id), []), tool_id, body)
    ...
    async def add_allowlist(self, entity_id: str, consumer_phone_number: str) -> dict[str, Any]:
        ...
        return self._create(self.allowlist.setdefault(entity_id, []), "entry", {"consumer_phone_number": consumer_phone_number})
