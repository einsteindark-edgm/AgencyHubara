...
_LAZY_EXPORTS: dict[str, str] = {
    ...
    "CouponSpec": "src.platform.promotions.coupon",
    ...
    "coupon_view_from_medusa": "src.platform.promotions.coupon",
    ...
    "QuotaAllocation": "src.platform.promotions.quotas",
    "QuotaGrant": "src.platform.promotions.quotas",
    "QuotaLine": "src.platform.promotions.quotas",
    "QuotaProduct": "src.platform.promotions.quotas",
    "QuotaRowError": "src.platform.promotions.quotas",
    ...
    "QuotaChanged": "src.platform.promotions.quota_lock",
    "QuotaLockTimeout": "src.platform.promotions.quota_lock",
    "register_under_quota": "src.platform.promotions.quota_lock",
