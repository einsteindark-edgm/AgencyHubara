...
- THEN la central responde 409 "Ese código ya existe." y no crea nada
...
- AND si un paso de una edición falla, responde 502 con el paso y el estado releído de Medusa (reintentar es seguro)
